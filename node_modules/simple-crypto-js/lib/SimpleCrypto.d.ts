 ...
 **/
import { Encoder, WordArray } from "crypto-js";
/**
 * SimpleCrypto
 *
 * @class
...
export declare class SimpleCrypto {
     ...
     */
    constructor(secret: string | WordArray);
     ...
     */
    static generateRandomWordArray(length?: number): WordArray;
    private _decrypt;
    private _encrypt;
    /**
     * Decrypt
     ...
     * @return  {SimpleCrypto}		Current SimpleCrypto instance.
     */
    setSecret(secret: string | WordArray): SimpleCrypto;
}
